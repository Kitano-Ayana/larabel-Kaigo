            ...
            @endif
              ...
              <div class="card">
                <div class="card-header">{{ $patient->patient_name}}さんの記録</div>
                    ...
                    <div class="log">
                    <p>過去の記録</p>
                    <a href="{{ route('admin.weightlog.show', ['id' => $patient->id]) }} ">体重</a>
                    <a href="{{ route('admin.bloodpressure.show', ['id' => $patient->id]) }} ">血圧</a>
                    </div>
                    <thead>
                        <tr>
                        <th scope="col">作成日</th>
                    ...
                    @foreach($conditions as $condition)
                     ...
                     <tbody>
                      <tr>
                       ...
                       <td><a href="{{ route('admin.condition.show',['id' => $condition->id]) }}">詳細を見る</a></td>
                     </tr>
                     </tbody>
                    @endforeach
                    </table>
